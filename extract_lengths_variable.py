...
length = "32.5"
variable = "density" # "viscosity"
# List of directories to process
directories = [
    "/media/data/March/copper_"+length+"um_0.25_"+variable,
    "/media/data/March/copper_"+length+"um_0.5_"+variable,
    "/media/data/March/copper_"+length+"um_1",
    "/media/data/March/copper_"+length+"um_2_"+variable,
    "/media/data/March/copper_"+length+"um_4_"+variable,
]

# Output CSV filename
output_csv = "/media/data/March/python/data/lengths_"+length+"_"+variable+".csv"

# Dictionary to store extracted data
data_dict = {}

# Use one simulation to extract the common time steps
reference_case = "/media/data/March/copper_"+length+"um_2_"+variable+"/case.foam"
